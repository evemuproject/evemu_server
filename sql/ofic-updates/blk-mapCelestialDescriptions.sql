# Generated by CacheToSQL on 20.04.2011 17:14:08 (UTC)
# Source: config.BulkData.mapCelestialDescriptions

DROP TABLE IF EXISTS blkMapCelestialDescriptions;
CREATE TABLE blkMapCelestialDescriptions (
    celestialID INT,
    description TEXT,
    PRIMARY KEY (celestialID)
);

INSERT INTO blkMapCelestialDescriptions (celestialID, description) VALUES
...
(10000008, 'Scalding Pass is a vast stellar nursery, the birth place of stars. A harsh and unforgiving region of space home to violent ion storms and rocked by intense solar winds, the Pass is littered with the wrecks of ships that were blindsided by the unpredictable dangers this region holds.
...
(10000011, '"Pirates. Scoundrels. Vagabonds. The most enigmatic of all the Minmatar tribes members are called many things, but no one truly knows them. I have researched them perhaps more than any scholar alive and still I feel I’ve barely scratched the surface."

<i>- The Travels of Germone Ferush </i>'),
(10000012, 'Once we were mighty,
...
(10000017, 'Children. <br><br>  Leave us be.'),
(10000018, '"The Spire! Oh God, the Spire! Warn everyone, warn your brothers, your sisters, warn your parents and your friends! Oh no, no, warn God, does he know? Warn him, the Spire! You must warn him!" '),
(10000019, '"It was like the gods of old, descending from the heavens and handing us fire, empowering us far beyond our comprehension.. and then vanishing."<br><br><i>- Treatise on the rise of the capsuleer.</i>'),
(10000020, 'Even before they were an Heir Family, the Tash-Murkon house controlled much of the space they now lend their name to. Thanks to their enterprising ways, the Tash-Murkon transformed the once-backwater locale into a bustling trade hub. Though the pressures and duties of being a Royal Family have rendered the region less of an economic juggernaut than it once was, Tash-Murkon continues to be the friendliest and easiest region of the Empire for the average trader to make a living in.
'),
...
(10000028, 'The common ground of the Heath, away from the bustling crowds of Heimatar and Metropolis, was in the days of the Elders committed as neutral ground between the Matari Tribes, to be claimed by none and developed by all.
...
(10000036, 'Only through many hardships
...
(10000047, 'The Empire long had its eye on the region it named Providence, a wealth of minerals on its border ripe for the plucking. Those plans were forced off the shelf with the Minmatar rebellion and the following disaster of Vak’Atioth. Hamstrung by these events and their repercussions, the expansion into Providence failed to materialize.
...
(10000048, 'In reality, Placid is anything but. The southern reaches of the region are home to the notorious Intaki, whose huge emphasis on personal freedom goes some way towards explaining its general lawlessness. The situation is not helped by the Federation''s seeming reluctance to invest heavily in the region - a source of some resentment among the Intaki who haven''t already fled to Syndicate.
...
(10000052, 'Despite belonging to the Heir House known as the "Old Imperial Family," Kador is one of the least developed regions in the Empire. The Kador Family has not been progressive in encouraging trade and investment into the region, favoring older, established Holder families with proven bloodlines and heritage. Though in many ways a musty embodiment of the old ways, Kador may be one of the few parts of Amarr territory where a traveler can still get a glimpse of the grand and majestic Empire of days gone by.'),
...
(10000054, '"It has been a long, tedious journey. Whilst my cartographer maintains that the distance from the central Throne Worlds is not great, the travails of getting here were, for many reasons, too tiresome to enumerate. The mineral survey report is also grim. It seems the riches we were led to expect are nowhere to be found. This region seems literally devoid of anything of worth, a desert with no oasis in sight, where even my faith seems to shrivel and die. Perhaps others will find worth here. I cannot."
...
(10000066, '0100100101110100011001010111001001100001011101000110010100100000011010010
...
(10000067, 'In the beginning all things were as one.
...
<i>- Dr Gullivaire at the Caille University, shortly before his prosecution for sedition</'),
(30001984, '"Get the pod, Get the Pod!"'),
(30002376, '"We can''t stop here, this is drone country"'),
(30003086, 'My word lies within all
...
<i>- Apocryphon, Lost Passages.</i>'),
(30003248, '"No silicon heaven?  Preposterous!  Where would all the rogue drones go?"');
